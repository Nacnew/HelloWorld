...
public class Note implements Serializable{//为什么要实现序列化接口？？？？？？？？？？？
	...
	private Long cn_note_create_time;//这里属性类型的设置需要看数据库中数据的具体格式
	private Long cn_note_last_modify_time;//long 或者Long类型都可以
